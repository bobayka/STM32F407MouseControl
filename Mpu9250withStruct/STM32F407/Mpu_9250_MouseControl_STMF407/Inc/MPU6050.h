...
// I2C bus timeout
#define MPU6050_I2C_TIMEOUTLEN 100

   // AK8963 registers
    #define AK8963_DEFAULT_ADDRESS  0x0C 
    #define AK8963_I2C_ADDR   (AK8963_DEFAULT_ADDRESS<<1)
...
typedef struct{
  uint8_t ASAX; /*!<  Sensitivity Adjustment value X axis */
	uint8_t ASAY; /*!<  Sensitivity Adjustment value Y axis */
	uint8_t ASAZ; /*!<  Sensitivity Adjustment value Z axis */
} MPU6050_SensMAGNETResult;
